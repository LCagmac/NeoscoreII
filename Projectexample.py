...
def refresh_func_new(time:float):
    ...
    neoscore.set_refresh_func(refresh_func_new, 60)

def refresh_func1_new(time:float):
    #Im.y = center + Mm(math.sin((time / 2)) * 10)
    ...
    neoscore.set_refresh_func(refresh_func1_new, 30)
